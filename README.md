...
| `research/` | Motivation runners for Figures 1–2 and Table 1 |
...
| Paper | Scripts |
|---|---|
| Fig 1 | `research/fig1_four_curve_frontier.py`, `research/run_hnsw_engine_comparison.sh` |
| Fig 2 / Table 1 | `research/controlled_selectivity_multidataset.py`, `research/page_locality_multidataset.py`, `research/filter_reuse_benchmark.py` |
