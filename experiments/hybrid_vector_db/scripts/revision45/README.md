...
|---|---|---|
| `run_b1_sql_first_q1k.py` | B1 | 14 Amazon row-local atoms: stock vs VisGuide vs SQL-first, q1K, ef=100 |
| `run_b2_join_warm.sh` | B2 | Figure 5 four SQL shapes with a resident `grocery_helpful` fragment |
| `run_c1_acorn_amazon14.sh` | C1 | pgvector `acorn1` vs stock vs `safe_guided` on Amazon-14 |
| `run_c2_failopen_write_sweep.sh` | C2 | Fail-open service path at 16 readers × {0,10,25,50,100} upd/s |
