...
out_dir="results/hybrid_vector_db/table6_r41_laion_target095"
out_csv="${out_dir}/laion_target095_paired_q10k.csv"
exit_file="${out_dir}/laion_target095_paired_q10k.tmux.exit"
...
"${python_bin}" \
  ...
  --workload-csv results/hybrid_vector_db/figure5_r37_formal_workloads/figure5_r37_laion_measurement.csv \
  ...
  --mode-configs-json experiments/hybrid_vector_db/configs/table6_r41_laion_target095_paired.json \
  ...
  --guidance-bypass-ef-search 5000 \
  --guidance-low-selectivity-bypass-ef-search 100000 \
  ...
  --d3-fragment-store-namespace table6-r41-laion-t095-q10k-prewarm-restart2 \
  --d3-probe-requests 2 \
