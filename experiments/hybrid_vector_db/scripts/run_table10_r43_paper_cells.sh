#!/usr/bin/env bash
# Table 9 / Table 10 paper cells only:
#   readers 16,64  x  update rates 0,100,1000
# Covers the four published operating points (plus 64/0 and 64/1000).
set -euo pipefail
...
out="$results/table10_r43/concurrency_paper/table10_r43_amazon_concurrency.json"
...
readers=${TABLE10_READERS:-16,64}
update_rates=${TABLE10_UPDATE_RATES:-0,100,1000}
