...
out_csv="${out_dir}/laion_target095_per_filter_paired_q5k_patch4.csv"
...
"${python_bin}" \
  ...
  --workload-csv results/hybrid_vector_db/figure5_r37_formal_workloads/figure5_r41_laion_measurement_q5000_patch4.csv \
  --expected-workload-requests 1434 \
  --require-unique-workload-queries \
  --filters-csv results/hybrid_vector_db/laion25m_matched_recall_filters_q180_orfreq.csv \
  --filter-names labelor_top55 labelor_top14 labelor_top3 label_1432 \
  ...
  --d3-fragment-store-namespace table6-r41-laion-t095-per-filter-q5k-patch4 \
  --d3-probe-requests 2 \
