...
out_dir="results/hybrid_vector_db/table6_r41_laion_target090_per_filter_q5k"
out_csv="${out_dir}/laion_target090_per_filter_calibration3_q600.csv"
mkdir -p "${out_dir}"
...
"${python_bin}" \
  ...
  --workload-csv results/hybrid_vector_db/figure5_r37_formal_workloads/figure5_r41_laion_calibration_q600_patch.csv \
  --expected-workload-requests 600 \
  --no-require-unique-workload-queries \
  --filters-csv results/hybrid_vector_db/laion25m_matched_recall_filters_q180_orfreq.csv \
  --filter-names labelor_top40 labelor_top20 labelor_top14 labelor_top9 label_175 label_79 \
  --modes original design1_bloom_bfs_layout_d3 \
  --execution-order interleaved \
  --schedule-seed 20260805 \
  --mode-configs-json experiments/hybrid_vector_db/configs/table6_r41_laion_target090_per_filter_modes.json \
  ...
  --d3-fragment-store-namespace table6-r41-laion-t090-calibration3 \
  --d3-probe-requests 2 \
